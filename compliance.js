...
(function () {
  ...
  function render() {
    ...
    if (s.regulated) {
      ...
      verdict = "<strong>Focus on product and sales.</strong> No buyer is asking and no regulation applies, so certification would be runway spent on theater. Do the security basics because they're cheap and right, then revisit this check each quarter.";
    }
